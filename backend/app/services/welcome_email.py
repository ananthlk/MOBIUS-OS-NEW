...
Configuration:
- MOBIUS_EMAIL_SKILL_URL  Base URL of the email skill (e.g. http://localhost:8081)
...
def send_welcome_email(
    *,
    ...
    try:
        import requests  # local import so import failure doesn't break auth boot
    except ImportError:
    ...
    try:
        ...
        return True
    except Exception as exc:  # network / timeout / json — never break signup
